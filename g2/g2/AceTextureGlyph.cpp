...
AceTextureGlyph::AceTextureGlyph() {
	glGenBuffers(1, &vid);
}
...
void AceTextureGlyph::draw(AceProgram* prog,
	AceTexture* texture,
...
void AceTextureGlyph::setVertexData(int left, int top, int charX, int charW, int charH, int atlasWidth) {
