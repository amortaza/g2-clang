...
void AceTextureRect::draw(AceProgram* prog, AceTexture* texture, int left, int top, int w, int h, glm::mat4* Projection, float* alphas, float topTextureCoord) {
    prog->activate();
...
void AceTextureRect::setVertexData(int left, int top, int w, int h, float topTextureCoord) {
    int right = left + w;
    int bottom = top + h;
